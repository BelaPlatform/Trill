...
export LoadConfig_trill_ring
export _LoadConfig_trill_ring
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_trill_ring
	lcall	LoadConfigTBL_trill_ring_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration trill_ring
;
;    Load configuration registers for trill_ring.
...
;               CUR_PP
;
_LoadConfig_trill_ring:
 LoadConfig_trill_ring:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_trill_ring_Bank0
    mov     X, <LoadConfigTBL_trill_ring_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_trill_ring_Bank1
    mov     X, <LoadConfigTBL_trill_ring_Bank1
