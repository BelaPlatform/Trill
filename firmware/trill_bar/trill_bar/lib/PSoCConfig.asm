...
export LoadConfig_trill_bar
export _LoadConfig_trill_bar
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_trill_bar
	lcall	LoadConfigTBL_trill_bar_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration trill_bar
;
;    Load configuration registers for trill_bar.
...
;               CUR_PP
;
_LoadConfig_trill_bar:
 LoadConfig_trill_bar:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_trill_bar_Bank0
    mov     X, <LoadConfigTBL_trill_bar_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_trill_bar_Bank1
    mov     X, <LoadConfigTBL_trill_bar_Bank1
