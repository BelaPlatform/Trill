...
export LoadConfigTBL_trill_flex_Bank1
export LoadConfigTBL_trill_flex_Bank0
export LoadConfigTBL_trill_flex_Ordered
AREA lit(rom, rel)
LoadConfigTBL_trill_flex_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_trill_flex_Bank1:
;  Instance name CSD, User Module CSD
;  Instance name EzI2Cs, User Module EzI2Cs
;  Instance name Timer16_1, User Module Timer16
...
LoadConfigTBL_trill_flex_Ordered:
