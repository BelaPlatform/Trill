...
export LoadConfig_trill_flex
export _LoadConfig_trill_flex
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_trill_flex
	lcall	LoadConfigTBL_trill_flex_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration trill_flex
;
;    Load configuration registers for trill_flex.
...
;               CUR_PP
;
_LoadConfig_trill_flex:
 LoadConfig_trill_flex:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_trill_flex_Bank0
    mov     X, <LoadConfigTBL_trill_flex_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_trill_flex_Bank1
    mov     X, <LoadConfigTBL_trill_flex_Bank1
