...
export LoadConfigTBL_trill_hex_Bank1
export LoadConfigTBL_trill_hex_Bank0
export LoadConfigTBL_trill_hex_Ordered
AREA lit(rom, rel)
LoadConfigTBL_trill_hex_Bank0:
...
LoadConfigTBL_trill_hex_Ordered:
