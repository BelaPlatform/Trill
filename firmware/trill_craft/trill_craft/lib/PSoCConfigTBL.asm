...
export LoadConfigTBL_trill_craft_Bank1
export LoadConfigTBL_trill_craft_Bank0
export LoadConfigTBL_trill_craft_Ordered
AREA lit(rom, rel)
LoadConfigTBL_trill_craft_Bank0:
...
;  Global Register values Bank 0
	...
	db		a0h, 20h		; CapSense_Ctrl0 register (CS_CR0)
	...
	db		ffh
LoadConfigTBL_trill_craft_Bank1:
;  Instance name CSD, User Module CSD
;  Instance name EzI2Cs, User Module EzI2Cs
;  Instance name Timer16_1, User Module Timer16
;  Global Register values Bank 1
	...
	db		d9h, e8h		; Port_1_MUXBusCtrl register (MUX_CR1)
	db		dah, 7fh		; Port_2_MUXBusCtrl register (MUX_CR2)
...
LoadConfigTBL_trill_craft_Ordered:
;  Ordered Global Register values
	...
	M8C_SetBank0
	mov	reg[04h], 17h		; Port_1_Data register (PRT1DR)
	M8C_SetBank1
