...
export LoadConfig_trill_craft
export _LoadConfig_trill_craft
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_1_Data_SHADE], 17h
	mov		[Port_2_Data_SHADE], 0h
	mov		[Port_3_Data_SHADE], 0h
	mov		[Port_4_Data_SHADE], 0h

	lcall	LoadConfig_trill_craft
	lcall	LoadConfigTBL_trill_craft_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration trill_craft
;
;    Load configuration registers for trill_craft.
...
;               CUR_PP
;
_LoadConfig_trill_craft:
 LoadConfig_trill_craft:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_trill_craft_Bank0
    mov     X, <LoadConfigTBL_trill_craft_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_trill_craft_Bank1
    mov     X, <LoadConfigTBL_trill_craft_Bank1
