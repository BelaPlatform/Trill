...
export LoadConfigTBL_trill_square_Bank1
export LoadConfigTBL_trill_square_Bank0
export LoadConfigTBL_trill_square_Ordered
AREA lit(rom, rel)
LoadConfigTBL_trill_square_Bank0:
...
;  Global Register values Bank 0
	...
	db		a2h, c0h		; CapSense_Ctrl2 register (CS_CR2)
	...
	db		ffh
LoadConfigTBL_trill_square_Bank1:
;  Instance name CSD, User Module CSD
;  Instance name EzI2Cs, User Module EzI2Cs
;  Instance name Timer16_1, User Module Timer16
;  Global Register values Bank 1
	...
	db		dah, ffh		; Port_2_MUXBusCtrl register (MUX_CR2)
...
LoadConfigTBL_trill_square_Ordered:
