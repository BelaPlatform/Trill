...
export LoadConfig_trill_square
export _LoadConfig_trill_square
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_trill_square
	lcall	LoadConfigTBL_trill_square_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration trill_square
;
;    Load configuration registers for trill_square.
...
;               CUR_PP
;
_LoadConfig_trill_square:
 LoadConfig_trill_square:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_trill_square_Bank0
    mov     X, <LoadConfigTBL_trill_square_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_trill_square_Bank1
    mov     X, <LoadConfigTBL_trill_square_Bank1
